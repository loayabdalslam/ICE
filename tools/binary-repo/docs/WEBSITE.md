...
| Platform | Script |
| --- | --- |
| Windows | `https://raw.githubusercontent.com/loayabdalslam/ICE/main/install.ps1` |
| Linux | `https://raw.githubusercontent.com/loayabdalslam/ICE/main/bash/install.sh` |
| macOS | `https://raw.githubusercontent.com/loayabdalslam/ICE/main/mac/install.sh` |
| Linux / macOS auto-detection | `https://raw.githubusercontent.com/loayabdalslam/ICE/main/install.sh` |
...
<script>
  const root = 'https://raw.githubusercontent.com/loayabdalslam/ICE/main';
  const commands = {
...
```bash
curl -fsSL https://raw.githubusercontent.com/loayabdalslam/ICE/main/install.sh | bash -s -- --version 0.2.0
```
